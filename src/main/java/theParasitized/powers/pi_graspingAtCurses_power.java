...
public class pi_graspingAtCurses_power extends AbstractPower {
    public static final String POWER_ID = "TheParasitized:pi_graspingAtCurses_power";
    ...
    public pi_graspingAtCurses_power(AbstractCreature owner, int amount){
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
