...
public class pi_cognitiveFilter_power extends AbstractPower {
    public static final String POWER_ID = "TheParasitized:pi_cognitiveFilter_power";
    ...
    public pi_cognitiveFilter_power(AbstractCreature owner, int amount){
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void onApplyPower(AbstractPower power, AbstractCreature target, AbstractCreature source) {
        if (power.owner== AbstractDungeon.player && power.type == PowerType.DEBUFF){
            this.addToBot(new GainBlockAction(target, this.amount));
        }
    }
}
