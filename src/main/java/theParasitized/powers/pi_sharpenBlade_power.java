...
public class pi_sharpenBlade_power extends AbstractPower {
    //test ok
    public static final String POWER_ID = "TheParasitized:pi_sharpenBlade_power";
    ...
    public pi_sharpenBlade_power(AbstractCreature owner, int amount){
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void onAttack(DamageInfo info, int damageAmount, AbstractCreature target) {
            this.addToBot(
                    new DamageAction(
                            target, new DamageInfo(this.owner, this.amount, DamageInfo.DamageType.NORMAL)
                    )
            );
    }
}
