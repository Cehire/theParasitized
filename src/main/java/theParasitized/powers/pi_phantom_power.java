...
public class pi_phantom_power extends AbstractPower {
    public static final String POWER_ID = "TheParasitized:pi_phantom_power";
    ...
    public pi_phantom_power(AbstractCreature owner, int amount){
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void onAttack(DamageInfo info, int damageAmount, AbstractCreature target) {
        this.flash();
        this.addToBot(new GainBlockAction(this.owner, damageAmount));
        this.amount--;
        if (this.amount <= 0){
