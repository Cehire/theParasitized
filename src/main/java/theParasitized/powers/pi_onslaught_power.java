...
public class pi_onslaught_power extends AbstractPower {
    public static final String POWER_ID = "TheParasitized:pi_onslaught_power";
    ...
    public pi_onslaught_power(AbstractCreature owner, int amount){
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
