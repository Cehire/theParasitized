...
public class testEventFight extends AbstractEvent {
    ...
    private testEventFight.CurScreen screen;

    public testEventFight() {
        this.screen = testEventFight.CurScreen.INTRO;
        ...
        switch(this.screen) {
            case INTRO:
                switch(buttonPressed) {
                    case 0:
                        this.screen = testEventFight.CurScreen.PRE_COMBAT;
                        ...
                        return;
                    case 1:
                        this.screen = testEventFight.CurScreen.END;
